...
#    source_variants = models.ManyToManyField('variants.Variant',  through = 'variants.SourceVariant')
...
#    def get_source(self,  media_type,  item):
#        sources = self.sourcevariant_set .all()
#        for source_variant in sources:
#            v = source_variant.variant
