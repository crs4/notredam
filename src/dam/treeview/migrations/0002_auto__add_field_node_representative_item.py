...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Node.representative_item'
        db.add_column('node', 'representative_item', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='represented_nodes', null=True, to=orm['repository.Item']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Node.representative_item'
        db.delete_column('node', 'representative_item_id')
    ...
    models = {
        ...
        'treeview.node': {
            ...
            'representative_item': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "'represented_nodes'", 'null': 'True', 'to': "orm['repository.Item']"}),
