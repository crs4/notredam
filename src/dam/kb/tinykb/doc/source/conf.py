# -*- coding: utf-8 -*-
#
# TinyKB documentation build configuration file, created by
# sphinx-quickstart on Fri Nov 18 11:08:46 2011, and extended by
...
project = u'TinyKB'
copyright = u'2011, Alceste Scalas <alceste@crs4.it>'
...
latex_documents = [
  ('index', 'TinyKB.tex',
   u'TinyKB: a dynamic class/object store and ORM for Python\\\\Developer\'s manual',
   u'Alceste Scalas \\textless{}alceste@crs4.it\\textgreater{}', 'manual'),
]
