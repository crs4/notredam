    ...
    ws_win = new Ext.Window({
        ...
        items:[
            new Ext.Panel({
                ...
                menu: [
                    {
                        ...
                        handler: function(item){
                            switch_toolbar('media_menu', item);
                            var store = Ext.getCmp('grid_variants').getStore();
                            var form_pnl = Ext.getCmp('form_panel');
                            form_pnl.media_type = 'image';
                            store.baseParams.media_type = 'image';
                            store.reload();
                        }
                    },
                    {
                        ...
                        handler: function(item){
                            ...
                            var store = Ext.getCmp('grid_variants').getStore();
                            var form_pnl = Ext.getCmp('form_panel');
                            form_pnl.media_type = 'movie';
                            store.baseParams.media_type = 'movie';
                            store.reload();
                        }
                    },
                    {
                        ...
                        handler: function(item){
                            ...
                            var store = Ext.getCmp('grid_variants').getStore();
                            var form_pnl = Ext.getCmp('form_panel');
                            form_pnl.media_type = 'audio';
                            store.baseParams.media_type = 'audio';
                            store.reload();
                        }
                    },
                    
                    {
                        ...
                        handler: function(item){
                            switch_toolbar('media_menu', item);
                            var form_pnl = Ext.getCmp('form_panel');
                            form_pnl.media_type = 'doc';
                            var store = Ext.getCmp('grid_variants').getStore();
                            
                            store.baseParams.media_type = 'doc';
                            store.reload();
                ...
                new Ext.Toolbar.TextItem({text: 'Variants:'}),
                {
                    text: 'Generated',
                    id: 'variant_menu',
                    menu:  [
                    {
                        ...
                        checked: true,
                        handler: function(item){
                            switch_toolbar('variant_menu', item);
                            
                            var grid = Ext.getCmp('grid_variants');
                            grid.sources = false;
                            var store = grid.getStore();
                            store.baseParams.type = 'generated';
                            store.reload();
                        }
                    },
                        ...
                        handler: function(item){
                            ...
                            store.reload({
                                callback: function(){
                                    var form_pnl = Ext.getCmp('form_panel');
                                    form_pnl.removeAll();
                                    var form = form_pnl.getForm();
                                    form.getEl().mask('No parameters available for imported variants');                                    
