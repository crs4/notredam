...
#                    else:
    ...
    def get_variants(self,  request,  workspace_id):
        ...
        - method: GET
            - parameters: none
        - returns: information on variants, for example {'preview': {'doc': {'preferences': {'watermark_uri': None, 'video_position': None, 'container': 'jpg', 'watermarking_position': None, 'codec': 'jpg', 'watermarking': False, 'cropping': False, 'max_dim': 300}, 'caption': '', 'id': 16, 'sources': [{'id': 14, 'name': 'original'}], 'media_type': 'doc', 'auto_generated': True}, 'image': {'preferences': {'watermark_uri': None, 'video_position': None, 'container': 'jpg', 'watermarking_position': None, 'codec': 'jpg', 'watermarking': False, 'cropping': False, 'max_dim': 300}, 'caption': '', 'id': 4, 'sources': [{'id': 2, 'name': 'edited'}, {'id': 1, 'name': 'original'}], 'media_type': 'image', 'auto_generated': True}, 'audio': {'preferences': {'preset': {'name': 'mp3', 'parameters': {}}}, 'caption': '', 'id': 9, 'sources': [{'id': 7, 'name': 'edited'}, {'id': 6, 'name': 'original'}], 'media_type': 'audio', 'auto_generated': True}, 'video': {'preferences': {'watermark_uri': None, 'preset': {'name': 'flv', 'parameters': {'audio_bitrate_kb': '128', 'video_bitrate_b': '640000', 'max_size': '320', 'audio_rate': '44100', 'video_framerate': '25/1'}}, 'watermarking_position': None, 'watermarking': False}, 'caption': '', 'id': 13, 'sources': [{'id': 11, 'name': 'edited'}, {'id': 10, 'name': 'original'}], 'media_type': 'video', 'auto_generated': True}}} 
